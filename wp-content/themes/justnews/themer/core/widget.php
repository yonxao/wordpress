        ...
        foreach ( $this->settings as $key => $setting ) {
            ...
            switch ( $setting['type'] ) {
                ...
                case 'upload':
                    ...
                    <script>
                        // Uploader
                        jQuery('#widgets-right').off('click.upload').on('click.upload', '.upload-btn', function(e) {
                            e.preventDefault();
                            var uploader, id = jQuery(this).attr('id');
                            if (uploader) {
                                uploader.open();
                            }else{
                                uploader = wp.media({
                                ...
                                uploader.on('select', function() {
                                    ...
                                    jQuery('#'+inputId).val(attachment.url).change();
                                });
                                uploader.open();
                            }
                        });
